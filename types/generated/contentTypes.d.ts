...
export interface ApiCertificateCategoryCertificateCategory
  extends Schema.CollectionType {
...
export interface ApiContactUsContactUs extends Schema.SingleType {
  ...
  attributes: {
    ...
    receiverTo: Attribute.Email & Attribute.Required;
    receiverCC: Attribute.Email;
    receiverBCC: Attribute.Email;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    bodyText1: Attribute.Blocks;
    bodyText2: Attribute.Blocks;
